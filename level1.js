...
`
  ...
  ** If you have time at the end, try and figure out how to take the
  ...
  const exercise7 = _ => {
    ...
    return compose(
     reduce((acc, prime) => checkPrimes(prime) ? acc + 1 : acc, 0),
